        ...
        <div className="overflow-hidden ">
            <div className="flex flex-col items-center justify-center gap-16 px-6  lg:flex-row py-28 md:px-24 md:py-20 lg:py-32 lg:gap-28">
                ...
                <div className="w-full lg:w-1/2">
                    ...
                    <Link to="/">
                        <button className="w-full px-1 py-5 my-4 text-white bg-indigo-600 border rounded-md lg:w-auto sm:px-16 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-700 focus:ring-opacity-50">Go back to Homepage</button>
                    </Link>
                </div>
            </div>
        </div>

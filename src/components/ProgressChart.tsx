...
//                 <div key={state} className="relative w-full h-3 transition rounded-full bg-jet group">
//                     <div style={{ width: percentage, background: colorKey[state] }} className="relative h-full text-xs text-center text-white rounded-full">
//                         {count > 0 &&
...
//                         <span style={{ background: colorKey[state] }} className="w-2 h-2 rounded-full"></span>
//                         <h3 >{state}</h3>
//                     </div>
//                 ))}
//             </div>
